...
public class ConcreteClassMES extends JFrame{
    ...
    public static List<Student> studentListMES = new ArrayList<>();


    public ConcreteClassMES(String title) {
        super(title);
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setContentPane(mainPanel);

        studentListMES.add(new Student("Adam", "Nowak", 1999,9, 1234, "Obecny"));

        ConcreteClassMES.StudentTableModel studentTableModel = new ConcreteClassMES.StudentTableModel(studentListMES);
        ...
        dodajStudentaButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e)
            {
                JFrame frame = new ConcreteAddMES("Add Student") ;
        ...
        usunStudentaButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ConcreteClassMES.StudentTableModel model= (ConcreteClassMES.StudentTableModel) tabelaStudentowPrzedmiotu.getModel();

                if(tabelaStudentowPrzedmiotu.getSelectedRowCount()==1)
                {
                    int index = tabelaStudentowPrzedmiotu.getSelectedRow();
                    studentListMES.remove(index);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        editstudent.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ConcreteClassMES.StudentTableModel model= (ConcreteClassMES.StudentTableModel) tabelaStudentowPrzedmiotu.getModel();
                int i = tabelaStudentowPrzedmiotu.getSelectedRow();
                studentListMES.set(i,new Student(
