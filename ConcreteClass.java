...
public class ConcreteClass extends JFrame{
    ...
    public static List<Student> studentListPR = new ArrayList<>();

    public ConcreteClass(String title) {
        super(title);
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setContentPane(mainPanel);

        studentListPR.add(new Student("Jakub", "Wrona", 1999,9, 1234, "Obecny"));

        StudentTableModel studentTableModel = new StudentTableModel(studentListPR);
        ...
        dodajStudentaButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e)
            {
                JFrame frame = new ConcreteAdd("Add Student") ;
        ...
        usunStudentaButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ConcreteClass.StudentTableModel model= (ConcreteClass.StudentTableModel) tabelaStudentowPrzedmiotu.getModel();

                if(tabelaStudentowPrzedmiotu.getSelectedRowCount()==1)
                {
                    int index = tabelaStudentowPrzedmiotu.getSelectedRow();
                    studentListPR.remove(index);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        editstudent.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ConcreteClass.StudentTableModel model= (ConcreteClass.StudentTableModel) tabelaStudentowPrzedmiotu.getModel();
                int i = tabelaStudentowPrzedmiotu.getSelectedRow();
                studentListPR.set(i,new Student(
